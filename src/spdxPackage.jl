...
const SpdxPackageV2_NameTable= Table(  
        ...
        Default= [  missing,            nothing,   missing,           missing,            missing,            missing,              missing,                    missing,          missing,                                Vector{SpdxChecksumV2}(),   missing,            missing,              missing,                          Vector{SpdxSimpleLicenseExpressionV2}(),  missing,                           missing,                   missing,                 missing,           missing,                missing,           Vector{SpdxPackageExternalReferenceV2}(),   Vector{String}(),            Vector{SpdxAnnotationV2}()],
    ...
    Constructor= [  string,             string,    string,            string,             string,             string,               string,                     Bool,             SpdxPkgVerificationCodeV2,              SpdxChecksumV2,             string,             string,               SpdxSimpleLicenseExpressionV2,    SpdxSimpleLicenseExpressionV2,            SpdxSimpleLicenseExpressionV2,     string,                    string,                  string,            string,                 string,            SpdxPackageExternalReferenceV2,             string,                      SpdxAnnotationV2],
