const SpdxPackageV2_NameTable= Table(  
    ...
    Default= [  nothing,  missing,  missing,        missing,           missing,    missing,       missing,             missing,          missing,                    Vector{ChecksumV2}(),   missing,     missing,       missing,             Vector{SpdxSimpleLicenseExpressionV2}(),  missing,            missing,            missing,          missing,    missing,              missing,    Vector{PackageExternalReferenceV2}(),  missing,                   Vector{String}()],
