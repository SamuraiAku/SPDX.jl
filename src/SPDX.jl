...
function __init__()
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxRelationshipV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxChecksumV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxAnnotationV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxLicenseInfoV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxLicenseCrossReferenceV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxPackageExternalReferenceV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxPkgVerificationCodeV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxPackageV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxCreationInfoV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxDocumentExternalReferenceV2_NameTable), Function))
    ...
    #precompile(convert_from_JSON, (Dict{String, Any}, typeof(SpdxDocumentV2_NameTable), Function))
