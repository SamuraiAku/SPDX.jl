...
const SpdxFileV2_NameTable= Table(
        ...
        Default= [  nothing,     nothing,    Vector{SpdxFileTypeV2}(),    Vector{SpdxChecksumV2}(),     missing,                         Vector{SpdxSimpleLicenseExpressionV2}(),   missing,             missing,                missing,         missing,         Vector{String}(),      Vector{String}(),        Vector{SpdxAnnotationV2}(),  ],
        Mutable= [  false,       false,      true,                        true,                         true,                            true,                                      true,                true,                   true,            true,            true,                  true,                    true,                        ],
    Constructor= [  string,      string,     SpdxFileTypeV2,              SpdxChecksumV2,               SpdxSimpleLicenseExpressionV2,   SpdxSimpleLicenseExpressionV2,             string,              string,                 string,          string,          string,                string,                  SpdxAnnotationV2,            ],
